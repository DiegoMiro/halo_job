...
```{r}
df_general_stats <- readr::read_csv("assets/data/general_stats.csv")
df_pl <- readr::read_csv("assets/data/pl.csv")
df_shot <- readr::read_csv("assets/data/shot.csv")
df_scoring <- readr::read_csv("assets/data/scoring.csv")
df_scorers <- readr::read_csv("assets/data/scorers.csv")
df_totallds <- readr::read_csv("assets/data/totallds.csv")
df_lds <- readr::read_csv("assets/data/lds.csv")
df_pbp <- readr::read_csv("assets/data/pbp.csv")
df_official <- readr::read_csv("assets/data/official.csv")
```
...
description_content <- "assets/data/description_content.csv" %>%
  readr::read_csv()
...
```{r}
match_data <- jsonlite::read_json("assets/data/match_2145647.json")
match_data %>%
  listviewer::reactjson(
    collapsed = TRUE,
    width = "1500px",
...
![](assets/img/img1.png){fig-align="center"}

## Overview (2/4)

![](assets/img/img2.png){fig-align="center"}

## Overview (3/4)

![](assets/img/img3.png){fig-align="center"}

## Overview (4/4)

![](assets/img/img4.png){fig-align="center"}
